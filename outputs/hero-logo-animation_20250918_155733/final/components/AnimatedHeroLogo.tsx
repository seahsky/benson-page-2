...
export const AnimatedHeroLogo: React.FC<AnimatedHeroLogoProps> = ({
  ...
  const handleMouseEnter = useCallback(() => {
    ...
    if (hoverAnimationsRef.current.scale && typeof hoverAnimationsRef.current.scale.restart === 'function') {
      hoverAnimationsRef.current.scale.restart();
    }
    if (hoverAnimationsRef.current.glow && typeof hoverAnimationsRef.current.glow.restart === 'function') {
      hoverAnimationsRef.current.glow.restart();
    }
    if (hoverAnimationsRef.current.rotation && typeof hoverAnimationsRef.current.rotation.restart === 'function') {
      hoverAnimationsRef.current.rotation.restart();
    }
