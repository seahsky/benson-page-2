...
export const content: Record<Language, Content> = {
  en: {
    ...
    coreBenefits: {
      ...
      subtitle:
        "Each client's goals, needs, and personal situation are different, so benefits vary accordingly. Beyond finding ideal jobs and careers, here are several core benefits I frequently observe:",
      quote: {
      ...
      benefits: [
        {
          ...
          description:
            "Many clients re-evaluate or even redefine their goals during the guidance process because they develop a deeper understanding of themselves and begin to know more clearly what they truly want in life and career.",
          icon: "Target",
          keyPoints: [
        ...
        },
        {
          ...
          description:
            "Many clients tell me that through our conversations, they see and can clearly articulate their strengths and abilities for the first time. Some even say that if it weren't for our discussions, they would never have applied for or obtained their dream job.",
          icon: "TrendingUp",
          keyPoints: [
      ...
      cases: [
        {
          ...
          background:
            "A chef who recognized that the food industry wasn't their lifelong passion and required high physical demands unsuitable for long-term work. They began seriously considering long-term career development and aimed for the Australian public service due to good salary and benefits, but lacked confidence in their ability to transition successfully without white-collar experience in Australia.",
          outcome:
            "Under Benson's guidance, A successfully packaged their transferable skills from different work experiences in Taiwan and Australia, achieved career transition success, and obtained permanent public service qualification!",
          industry: "Government",
        },
        {
          id: "working-holiday-to-pr",
          title: "Working Holiday to PR",
          background:
            "B came to Australia on a working holiday and fell in love with the country, beginning to explore immigration possibilities. Without a university degree from Taiwan and limited English skills, B lacked confidence in studying in Australia and applying for skilled migration. Additionally, B felt lost among various factors including financial burden, personal interests, and immigration probability, uncertain about their next steps.",
          outcome:
            "Benson helped B clarify their personal aspirations and identify the most suitable study plan. B successfully graduated while managing economic needs and achieved successful immigration!",
        ...
        },
        {
          ...
          background:
            "C, who already had extensive professional work experience in Australia, sought Benson's help to challenge themselves for a management position.",
          outcome:
            "Within approximately one month, C received four interview opportunities, obtained two offers, and was placed on the shortlist for the other two!",
          testimonial:
        ...
        },
        {
          ...
          background:
            "D initially applied to forty to fifty positions with no response, becoming disheartened and finding Benson. At the time, D felt anxious, inferior, and self-doubting due to their status as a new immigrant and returning mother.",
          outcome:
            "But now D has not only found work but also started studying courses of interest, hoping to go higher and further in their field of interest in the future!",
          testimonial:
      ...
      certifications: [
        {
          ...
          shortName: "ICF ACC",
          description:
            "Globally recognized coaching certification ensuring professional coaching standards and ethics",
        },
        {
    ...
    contact: {
      ...
      subtitle:
        "Get in touch to start your professional journey with personalized coaching",
      channels: [
        {
          name: "whatsapp",
          label: "WhatsApp",
  ...
  zh: {
    ...
    coreBenefits: {
      ...
      subtitle:
        "每位客戶的目標、需求與個人情況不同，因此收穫也各不相同。除了找到理想的工作與職涯之外，我經常看到的幾個核心收穫包括：",
      quote: {
      ...
      benefits: [
        ...
        },
        {
          ...
          title: "自信心提升",
          description:
            "許多客戶跟我說，透過我們的對話，他們第一次真正看見並能清楚表達自己的優勢與能力。有些人甚至說，如果不是因為與我談過，他們根本不會去申請、也不會拿到夢寐以求的工作。這份自信非常強大，能幫助他們在未來面對各種職涯與人生挑戰。",
          icon: "TrendingUp",
          keyPoints: [
            "清楚認識並表達個人優勢",
            "建立追求夢想機會的信心",
      ...
      cases: [
        {
          ...
          title: "廚師轉公務員",
          background:
            "原本是廚師的 A 認為餐飲業並非終生志趣所在，而且對體力要求較高，恐不適合長期從事，所以開始認真思考長期的職涯發展。長期聽說澳洲公務員薪資福利都還不錯的 A 開始朝這個方向準備，然而在澳洲沒有文職經驗的 A 對自己能否轉職成功感到缺乏信心。",
          outcome:
            "在 Benson 的輔導下 A 成功的包裝自己過去從台灣及澳洲不同工作經驗中累積的 transferrable skills 轉職成功，取得永久性公務員的資格！",
          industry: "政府部門",
        },
        {
          id: "working-holiday-to-pr",
          title: "打工度假轉永久居民",
          background:
            "B 來澳洲打工度假後覺得很喜歡這裡，開始探索移民的可能性。在台灣沒有大學學歷，英文又不是很好的 B 對自己要在澳洲讀書進而申請技術移民相當沒有自信。此外 B 也在經濟負擔、個人興趣與移民機率等各種因素中感到迷失，不確定自己的下一步該怎麼走。",
          outcome:
            "Benson 幫 B 明確了個人志向及最適合的進修方案。B 在能兼顧經濟需求的狀況下順利畢業且成功移民！",
          industry: "教育與移民",
        },
        {
          id: "management-position-success",
          title: "管理職位成功",
          background:
            "已經在澳洲有豐富專業工作經歷的 C 因為想要挑戰主管職而找到了 Benson。",
          outcome:
            "在大約一個月的時間裡， C 得到了四個面試機會，拿到兩個 offers，另外兩個也有進入候補名單！",
          testimonial:
        ...
        },
        {
          ...
          title: "新移民媽媽的成功",
          background:
            "D 在剛開始求職的時候投了四五十個履歷都石沉大海，灰心喪志之餘找到了 Benson。當時的 D 因為自己新移民和二度就業媽媽的身分備感焦慮、自卑與自我懷疑。",
          outcome:
            "但是現在的 D 不但找了工作，也開始進修有興趣的課程，希望將來能在有興趣的專業領域走得更高更遠！",
          testimonial:
        ...
        },
        {
          ...
          title: "畢業生計劃成功",
          background:
            "持有畢業生簽證的 E 成功被州政府的畢業生計畫錄取！以臨時簽證的身分被錄用為澳洲公務員已經頗為難得，還是這種連本地人都相當難進，會獲得大量栽培資源的計畫！",
        ...
        },
        {
          ...
          title: "重返澳洲就業市場",
          background:
            "F 回國一陣子重回澳洲後發現就業市場競爭激烈，履歷投出後往往石沉大海。F 在 Benson 的工作申請引導後成功獲得了心儀的工作，並持續透過職涯引導更好的應對新職場的挑戰，及做長線的職涯佈局。",
