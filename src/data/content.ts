      ...
      benefits: [
        {
          ...
          title: "目標更明確，自我認識提升",
          description:
            "許多客戶在引導關係中會經歷一次「思維重組」，重新評估甚至重新定義自己的目標。因為他們對自己有了更深層的了解，開始更清楚地知道自己在人生與職涯中真正想要的是什麼。",
          icon: "Target",
          keyPoints: [
            "看見那些被自己視為理所當然，但在僱主眼中卻價值連城的獨特亮點",
            "不再亂槍打鳥，找到一條既符合天賦熱情，又能與市場需求接軌的職涯路徑",
            "跳脫短期焦慮，規劃出具備複利效應的長期成長地圖",
          ],
        },
        {
          id: "increased-confidence",
          title: "自信心提升",
          description:
            "許多客戶跟我說，他們第一次真正看見並能清楚表達自己的優勢與能力。有些甚至說如果不是因為我，他們根本不會去申請、也不會拿到夢寐以求的工作！",
          icon: "TrendingUp",
          keyPoints: [
            "消除「我不配」的內在雜音，從內而外散發出配得感",
            "打破完美主義魔咒，展現自信與力量",
            "獲得終生受用的強大自信，即使在引導關係結束後依然能從容面對各種職涯與人生挑戰",
          ],
        },
        {
          id: "enhanced-motivation",
          title: "行動力提升",
          description:
            "焦慮及拖延往往來自於不知道從何下手。透過將龐大的計畫拆解成一個個具體步驟，我的客戶會發覺事情變得可行，也因此更有動力讓改變真實發生！",
          icon: "Zap",
          keyPoints: [
            "釐清優先級、最有效的任務執行順序及時間表",
            "制定即時行動計畫，用「小贏」帶來的多巴胺累積動能",
            "善用「蔡加尼克效應」，讓大腦自動產生強烈的內在驅動力",
          ],
        },
        {
          id: "peace-of-mind",
          title: "安心與踏實感",
          description:
            "移民、轉職或重返校園，都是人生的重大決定，甚至牽動全家。在這些充滿不確定性的時刻，客戶透過和我一起深度的梳理思緒與風險盤點，獲得深刻的確認感。",
          icon: "Heart",
          keyPoints: [
            "停止無止盡的內耗與糾結，獲得做出重大人生決定的勇氣與依據",
            "認知到自己已經深思熟慮，做最適合當下的決定，進而培養面對未知的韌性",
            "在一個絕對保密且不帶批判的空間裡，讓情緒找到安全的出口",
          ],
        },
      ],
    },
      ...
      plans: [
        {
          ...
          targetAudience: "需要針對特定挑戰診斷或急救，或是想先體驗教練模式或教練風格的您",
          price: 258,
          features: [
            "60 分鐘深度晤談",
            "個人化職涯指導",
        ...
        },
        {
          ...
          contractDuration: "3個月*",
          targetAudience: "正積極求職或面對職涯挑戰，想要在短時間內取得階段性進展的您",
          price: 1088,
          additionalRate: 198,
          features: [
            "5 × 60 分鐘晤談",
        ...
        },
        {
          ...
          targetAudience: "想進行深度職涯規畫或轉型，或是希望將自己的心態及思維進行一次系統性升級的您",
          price: 2088,
          additionalRate: 178,
          features: [
            "10 × 60 分鐘晤談",
      ...
      cases: [
        {
          ...
          background:
            "原本在澳洲從事廚師的 Alex 其實心裡一直都知道這份高強度的體力勞動工作並非終生志趣所在，所以在拿到公民身份後開始認真思考長期的職涯機會，並決定轉往薪資福利相對穩定的澳洲公職發展。然而由於不熟悉澳洲的求職與公職申請的技巧，Alex 在職涯轉換的十字路口感到缺乏信心。",
          outcome:
            "在 Benson 的輔導下，Alex 掌握了撰寫高品質澳洲公職履歷與申請書的關鍵技巧。更重要的是，他挖掘出自己從過往台灣與澳洲不同工作經驗中通用的「可轉移技能 (transferable skills)」。經過優勢的重新包裝與定位，Alex 成功跨越了工作領域及心理上的鴻溝，取得了許多人夢寐以求的澳洲公部門永久職位！",
          testimonial:
            "如果有人跟剛來澳洲打工度假那時候的我說幾年後我會成為澳洲公務員，我一定會覺得他瘋了！然而在 Benson 的協助下，這個一度讓我覺得遙不可及的夢想，現在卻是我每天的日常！感謝 Benson 的引導啟發了我不同的思維，讓我在澳洲找到了一份可以長久做下去，又符合我個人興趣的工作。即使我現在的工作跟我過往經歷都不直接相關，但那些經驗都沒有白費。我從中累積的 transferable skills 都成為了我能得到這份工作的助力。",
        ...
        },
        {
          ...
          background:
            "Brian 在結束打工度假後深深喜歡上澳洲的環境，渴望能透過留學途徑移民。然而，他在台灣沒有大學學歷，對自己的英文能力也缺乏自信，對於這條路的可行性感到懷疑。此外，面對經濟負擔、個人興趣與移民成功率這三個可能需要取捨的因素，Brian 陷入了決策癱瘓，完全不確定下一步該往哪走。",
          outcome:
            "Benson 協助 Brian 釐清了深層的個人志向，並在眾多選項中篩選出最適合他的進修方案。Brian 成功找到了一個能兼顧所有需求的選項，在完成學業後順利移民澳洲，後來更成功創業，開啟在澳洲精彩的第二人生！",
          testimonial:
            "很榮幸能成為 Benson 的成功案例之一，在此特別感謝 Benson 在我人生關鍵階段所給予的專業建議與實際協助，讓我得以發揮自身的最大潛能。Benson 在與我深入晤談後，能迅速掌握我的背景與條件，並對可能的方向提出清楚、精準且具可行性的建議，協助我重建一度低落的自信，也讓我的思考跳脫既有框架。後來我在眾多選擇之中，找到真正適合自己的道路，最終讓我從一個大學肄業、徬徨的高齡背包客，成功取得澳洲學士學歷，並完成移民與創業的目標。選擇 Benson，他會引導你做出正確的決定。而當你選對方向，努力終將讓人生徹底翻轉。",
        ...
        },
        {
          ...
          background:
            "Chloe 在澳洲已有豐富的專業工作經歷，但當她試圖挑戰更高階的管理職時，卻發現自己撞上了隱形天花板。即使申請的是自己經驗完全足以勝任的職缺，卻依然屢屢受挫。",
          outcome:
            "在大約一個月的密集引導與策略調整後，Chloe 勢如破竹地獲得了四個面試機會，最終成功拿下兩個 offers，另外兩個也進入候補名單！",
          testimonial:
        ...
        },
        {
          ...
          background:
            "Doris 剛開始求職時，投遞了四五十封履歷卻全數石沉大海。身為「新移民」又是「二度就業媽媽」，這雙重身分帶來的標籤讓她備感焦慮、自卑與自我懷疑，甚至開始灰心喪志，覺得自己在這個市場毫無價值。",
          outcome:
            "經過諮詢，Doris 發現原本以為「沒什麼用」的台灣職涯經歷，經過適度包裝後竟能成為澳洲履歷上的亮點。現在的她不但順利找到工作，更重拾學習熱情，開始進修專業課程，為長遠職涯鋪路。",
          testimonial:
