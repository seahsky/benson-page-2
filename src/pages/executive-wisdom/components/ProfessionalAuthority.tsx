...
import { Award, GraduationCap, Building, Users, Calendar, MessageCircle } from 'lucide-react'
...
export default function ProfessionalAuthority({ content, language }: ProfessionalAuthorityProps) {
      ...
      <div className="container-custom">
        ...
        <div className="mb-16 fade-in-up stagger-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {content.certifications.map((cert, index) => (
              <Card key={index} className="group bg-gradient-to-br from-primary/5 to-secondary/5 border-2 border-primary/20 hover:border-primary/40 card-elevated transition-all duration-300">
                <CardHeader className="pb-4">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <Badge variant="credential" className={`mb-2 ${language === 'zh' ? 'font-chinese' : ''}`}>
                        {cert.shortName}
                      </Badge>
        ...
        <div className="mb-16 fade-in-up stagger-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {content.qualifications.map((qual, index) => (
              <Card key={index} className="group bg-white border border-neutral-200 hover:border-secondary/30 card-elevated">
        ...
        <div className="mb-16 fade-in-up stagger-3">
          <div className="bg-gradient-to-r from-neutral-50 to-primary/5 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Badge variant="experience" className={`text-lg px-4 py-1 ${
                        language === 'zh' ? 'font-chinese' : ''
                      }`}>
                    ...
                    <h3 className={`text-2xl font-bold text-neutral-800 ${
                      ...
                      {language === 'zh' ? '專業經驗' : 'Professional Experience'}
                    </h3>
                  </div>
                </div>
                ...
                >
                  <a href={whatsappLink} target="_blank" rel="noopener noreferrer">
                    ...
                    {language === 'zh' ? '體驗專業指導' : 'Experience Professional Guidance'}
                  </a>
                </Button>
              </div>
              ...
              {/* Specialties */}
              <div>
                <h4 className={`text-xl font-semibold text-neutral-800 mb-6 flex items-center gap-2 ${
                  language === 'zh' ? 'font-chinese' : ''
                }`}>
                ...
                <div className="space-y-4">
                  {content.experience.specialties.map((specialty, index) => (
                    <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-lg shadow-sm border border-neutral-100 hover:shadow-md transition-all duration-300">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 fade-in-up stagger-4">
          {[
            {
              number: "ICF ACC",
              label: language === 'zh' ? '國際認證' : 'International Certification',
              icon: Award
            },
            {
              number: "15+",
            ...
            <div key={index} className="text-center p-6 bg-white rounded-lg shadow-sm border border-neutral-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
...
// Quote component for the blockquote
function Quote({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
